                        ...
                        <div class="compensation-group__body compensation-group__body--balances">
                          ...
                          >
                            <label>
                              ...
                              <input type="text" name="accrualMethod" maxlength="100" value="${selectedConfig?.accrualMethod ? escapeHtml(selectedConfig.accrualMethod) : ''}"${selectedConfig?.accrualEnabled ? '' : ' disabled'} />
                            </label>
                            <label>
                              <span>PTO Balance (hours)</span>
                              <input type="number" name="ptoBalanceHours" step="0.25" value="${selectedConfig ? makeNumberValue(selectedConfig.ptoBalanceHours) : ''}" required${selectedConfig?.accrualEnabled ? '' : ' disabled'} />
                            </label>
                            <label>
                              <span>UTO Balance (hours)</span>
                              <input type="number" name="utoBalanceHours" step="0.25" value="${selectedConfig ? makeNumberValue(selectedConfig.utoBalanceHours) : ''}" required${selectedConfig?.accrualEnabled ? '' : ' disabled'} />
                            </label>
                            <label>
